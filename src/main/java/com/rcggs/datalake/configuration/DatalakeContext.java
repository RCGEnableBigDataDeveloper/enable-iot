...
public class DatalakeContext {
	...
	public static ConcurrentMap<String, String> getSchemaReaders() {
	...
	public static void scheduleJob(final String name, final String group, final String description, final Class<? extends Job> clazz, final Date start, final Date end,
			final String cron, final Map<String, Object> data) throws SchedulerException, ParseException {

		JobDetail job = JobBuilder.newJob(clazz).withIdentity(name, group).usingJobData(data != null ? new JobDataMap(data) : new JobDataMap()).build();
