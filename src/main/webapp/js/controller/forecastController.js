...
var ForecastController = (function() {
	...
	function init(start, end) {
		...
		$("#historytable")
				.append(
						"<tr class='gradient1'><td class=bordercell>Type</td><td class=bordercell>Date</td><td class=bordercell>Account</td><td class=bordercell>Vendor</td><td class=bordercell>Address</td></tr>");
			...
			if (inRange) {
				...
				$("#historytable").append(
						"<tr><td class=bordercell width=20><img src='/img/" + transaction[1] + ".png'/></td><td width=75 class=bordercell nowrap>" + transaction[0]
								+ "</td><td width=75 class=bordercell nowrap>" + transaction[2] + "</td><td width=300 class=bordercell nowrap>" + transaction[3]
								+ "</td><td class=bordercell nowrap>" + transaction[4] + "</td></tr>");
			}
		...
		if (dates.length == 0) {
			$
					.ajax({
						url : '/dataservice/getInventoryLevel/' + "name",
						success : function(result) {
