...
var ForecastController = (function() {
	...
	function init(start, end) {
		...
		$("#timelinedatesdisplay").html('')
		$("#historytable").html('');
		$("#historytable")
				.append(
						"<tr class='gradient1'><td class=bordercell>Type</td><td class=bordercell>Date</td><td class=bordercell>Account</td><td class=bordercell>Provider/Plan</td><td class=bordercell>Event</td><td class=bordercell>Source</td><td class=bordercell>Location</td></tr>");
		...
		$.each(dates, function(i, transaction) {
			...
			if (inRange) {
				...
				$("#historytable").append(
						"<tr><td class=bordercell width=20><img src='/img/" + transaction[1] + ".png'/></td><td width=75 class=bordercell nowrap>" + transaction[0]
								+ "</td><td width=75 class='bordercell healthrow' nowrap style='cursor:pointer'>" + transaction[2] + "</td><td width=300 class=bordercell nowrap>" + transaction[3]
								+ "</td><td class=bordercell nowrap>" + transaction[4] + "</td><td class=bordercell nowrap>" + transaction[5] + "</td><td class=bordercell nowrap>"
								+ transaction[6] + "</td></tr>");
			}
		...
		if (dates.length == 0) {
			$
					.ajax({
						url : '/dataservice/getHealthData/' + "health",
						success : function(result) {

							$("#historytable").html('');
							$("#historytable")
									.append(
											"<tr class='gradient1'><td class=bordercell>Type</td><td class=bordercell>Date</td><td class=bordercell>Account</td><td class=bordercell nowrap>ProviderAAA</td><td class=bordercell>EventBBB</td></td><td class=bordercell>EventDDD</td></tr>");
							$.each(result, function(i, elem) {
								...
								if (inRange) {
									$("#historytable").append(
											"<tr><td class=bordercell width=20><img src='/img/" + transaction[1] + ".png'></td><td class=bordercell nowrap width=75>"
													+ transaction[0] + "</td><td class=bordercell nowrap width=75>" + transaction[2]
													+ "</td><td width=300  class=bordercell nowrap>" + transaction[3] + "</td><td class=bordercell nowrap>" + transaction[4]
													+ "</td><td class=bordercell nowrap>" + transaction[5] + "</td><td class=bordercell nowrap>" + transaction[6] + "</td></tr>");
								}
							...
							for (var i = 1; i < _timelinerows_.length; i++) {
								...
								var timelinejson = {
									...
									"text" : {
										"headline" : timelinedetail[4].innerText,
										"text" : ""
									},
									"media" : {
