...
<body onload="">
	...
	<script src="/js/controller/healthController.js"></script>
	<script>
		var today = new Date();
		(function($) {
			...
			//setInterval(function(){$('#dateSlider2').rangeSlider('scrollRight', 10); }, 3000);
		...
		$("#dateSlider2").bind("valuesChanging", function(e, data) {
		...
		$("#dateSlider2").bind("valuesChanged", function(e, data) {
			...
			//parent.frames['timelineframe'].contentWindow['onLoad'](timelinerows);
		});
	</script>
</body>
</html>